                ...
                <div className="container-fluid">
                    <div className="row _yhgttr">
                        <div className="col-lg-5 p-0 abt-pic img-fluid">
                                        <img src={require("../../../../assets/portfolio/images/about.jpg")} alt="" className="img-fluid" />
                        </div>
                            ...
                            <div className="about-right">
                                ...
                                <div className="row mt-sm-5 mt-4 about-right-inner">
                                    <div className="col-sm-4 col-6 myphoto-sign text-center">
                                            <img src={require("../../../../assets/portfolio/images/myphoto.png")} alt="" className="img-fluid rounded-circle"/>
                                            <img src={require("../../../../assets/portfolio/images/signature.png")} alt="" className="img-fluid mt-3"/>
