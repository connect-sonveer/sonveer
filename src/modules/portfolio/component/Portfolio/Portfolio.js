            ...
            <div className="container py-lg-5">
                ...
                <div className="row">
                    ...
                    <div className="col-lg-4 col-md-4 col-6 p-0">
                        <div className="box9">
                            <img className="myImg img-fluid" src={require("../../../../assets/portfolio/images/portfolio1.jpg")} alt="Shopkart"/>
                                ...
                                <div className="col-lg-4 col-md-4 col-6 p-0">
                        <div className="box9">
                            <img className="myImg" src={require("../../../../assets/portfolio/images/portfolio2.jpg")} alt="Hello42 Cabs" className="img-fluid" />
                            <div className="box-content">
                    ...
                    <div className="col-lg-4 col-md-4 col-6 p-0">
                        <div className="box9">
                            <img src={require("../../../../assets/portfolio/images/portfolio3.jpg")} alt="priceveille" className="img-fluid" />
                            <div className="box-content">
                    ...
                    <div className="col-lg-4 col-md-4 col-6 p-0">
                        <div className="box9">
                            <img src={require("../../../../assets/portfolio/images/portfolio4.jpg")} alt="Shopkart" className="img-fluid" />
                            <div className="box-content">
                                <h3 className="title">Shopkart</h3>
                                <ul className="icon">
                                    <li><a href="#portfolio" className="prt-clk"><i className="fa fa-search"></i></a></li>
                    ...
                    <div className="col-lg-4 col-md-4 col-6 p-0">
                        <div className="box9">
                            <img src={require("../../../../assets/portfolio/images/portfolio5.jpg")} alt="SiteCompli" className="img-fluid" />
                            <div className="box-content">
                                ...
                                <div className="col-lg-4 col-md-4 col-6 p-0">
                        <div className="box9">
                            <img src={require("../../../../assets/portfolio/images/portfolio6.jpg")} alt="DravyaSoft" className="img-fluid" />
                            <div className="box-content">
