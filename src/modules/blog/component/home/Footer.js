...
import flogo from '../../../../assets/blog/images/flogo.png';
                ...
                <footer className="footer">
                        <div className="container">
                                    ...
                                    <div className="blog-list-widget">
                                        <div className="list-group">
                                            ...
                                            <div className="w-100 justify-content-between">
                                                <img src={blog_square} alt="" className="img-fluid float-left"></img>
                            ...
                            <div className="row">
                                ...
                                <div className="widget">
                                    <div className="footer-text text-center">
                                        <a href="index.html"><img src={flogo} alt="" className="img-fluid"></img></a>
                            ...
                            <div className="row">
                                ...
                                <br></br>
                                <div className="copyright-design">&copy; Cloapedia. Design: <a href="http://html.design">HTML Design</a>.</div>
                                </div>
                            </div>
                        </div>
                    </footer>
