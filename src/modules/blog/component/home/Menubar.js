                                        ...
                                        <ul className="dropdown-menu megamenu" aria-labelledby="dropdown01">
                                            <li>
                                                <div className="mega-menu-content clearfix">
                                                    <div className="tab">
                                                        <button className="tablinks active" onClick={this.openCategory('cat01')}>Beauty</button>
                                                            <button className="tablinks" onClick={this.openCategory('cat02')}>Fashion</button>
                                                            <button className="tablinks" onClick={this.openCategory('cat03')}>Travel</button>
                                                        <button className="tablinks" onClick={this.openCategory('cat04')}>Architecture</button>
                                                        <button className="tablinks" onClick={this.openCategory('cat05')}>Recipes</button>
                                                    </div>
