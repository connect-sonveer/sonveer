            ...
            <div className="container py-3">
                ...
                <div className="middile-inner-con">
                    <div className="tab-main mx-auto">
                        ...
                        <label htmlFor="tab1"><img src="images/s1.png" alt="" className="img-fluid" /> Icreon Communications</label>

                        <input id="tab2" type="radio" name="tabs"></input>
                        <label htmlFor="tab2"><img src="images/s2.png" alt="" className="img-fluid" /> nKAPs Intellects</label>

                        <input id="tab3" type="radio" name="tabs"></input>
                        <label htmlFor="tab3"><img src="images/s4.png" alt="" className="img-fluid" /> Shivlania Enterprises</label>
